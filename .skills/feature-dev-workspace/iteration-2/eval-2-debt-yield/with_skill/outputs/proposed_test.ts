/**
 * Test: Debt Yield Metric Detection in Dashboard Generation
 *
 * FILE: repo-b/src/app/api/re/v2/dashboards/generate/route.test.ts
 *
 * These tests verify that the DEBT_YIELD metric is properly detected
 * when users mention "debt yield" or "dy" in their dashboard prompts.
 */
