...
const HERO_BG = '/assets/bg-saas-iceberg.jpg';
  ...
  return (
    <>
      <HeroBackground imageSrc={bgSrc} imageAlt="" overlayOpacity={0.5}>
        <p className="nv-eyebrow"><span className="nv-eyebrow-dot" />Legacy SaaS</p>
        <h1 className="nv-h1" style={{ marginTop: 18, marginBottom: 24 }}>
          Legacy SaaS <em>migration</em>.
        </h1>
        <p className="nv-lede">
          SaaS sprawl creates duplicated logic, fragmented workflows, and expensive change requests. We replace it with one controlled execution layer.
        </p>
