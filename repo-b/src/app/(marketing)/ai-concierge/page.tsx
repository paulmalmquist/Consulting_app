...
export const metadata: Metadata = {
  title: 'AI Concierge | Novendor',
  description:
    'Discover where AI is being used across your business, turn scattered activity into governed workflows, and scale what works — safely.',
  alternates: { canonical: '/ai-concierge' },
  openGraph: {
    title: 'AI Concierge | Novendor',
    description:
      'Discover where AI is being used across your business, turn scattered activity into governed workflows, and scale what works — safely.',
    url: 'https://www.novendor.ai/ai-concierge',
    type: 'website',
  },
};
