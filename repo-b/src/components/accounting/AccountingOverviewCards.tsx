...
export default function AccountingOverviewCards() {
  ...
  if (!ready) {
    return (
      <section className="space-y-3" data-testid="accounting-overview-cards">
        <h2 className="text-sm font-semibold text-bm-muted2 uppercase tracking-[0.14em]">Financial Overview</h2>
