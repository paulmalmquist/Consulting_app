  ...
  },
  {
    ...
    lanes: [
      ...
      { id: "live-evidence", lane: "evidence", label: "Stream block", realName: "svc.monitoring → tel_pipeline_status",
        detail: "Reads stream_status only — never a raw sensor value.", impl: "built", verify: "prod_verified", evidenceSlug: "monitoring" },
  ...
  },
  {
    ...
    lanes: [
      ...
      { id: "med-evidence", lane: "evidence", label: "Gold aggregate", realName: "tel_stream_minute_agg",
        detail: "1-minute aggregates, guarded by watermarks + tel_dq_assertions.", impl: "built", verify: "prod_verified", evidenceSlug: "monitoring" },
