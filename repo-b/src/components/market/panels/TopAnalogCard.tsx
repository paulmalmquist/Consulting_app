...
export function TopAnalogCard({ analogOverlay, radarDims }: TopAnalogCardProps) {
  return (
    <Card className="p-4">
      ...
      <div className="flex items-start justify-between mb-4 pb-3 border-b border-bm-border/30">
        <div>
          ...
          <p className="text-[10px] text-bm-muted mt-1">
            Key similarity: tightening + leverage stress
          </p>
          <p className="text-[10px] text-bm-muted2 mt-0.5">
            Key divergence: labor market holding longer this cycle
          </p>
        </div>
        <div className="text-right">
          <p className="text-[9px] text-bm-muted2 uppercase">Rhyme Score</p>
          <p className="text-2xl font-bold font-mono text-bm-accent">0.78</p>
        </div>
      </div>
