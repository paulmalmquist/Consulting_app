...
const ARCHITECTURE_STAGES = [
  ...
  },
  {
    ...
    name: "AI / Interaction",
    color: "#c084fc",
    tools: ["GenAI", "Genie", "LangChain"],
    what: "Natural language query layer on top of governed semantic models. Genie routes analyst questions to validated gold tables. GenAI orchestration produces structured insights.",
