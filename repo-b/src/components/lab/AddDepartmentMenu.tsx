    ...
    <div className="relative" ref={menuRef}>
      ...
      {open ? (
        <div
          ...
          className="absolute left-0 top-full z-50 mt-1 w-48 rounded-lg border border-bm-border/70 bg-bm-bg/95 shadow-lg backdrop-blur-sm"
        >
          {availableDepartments.map((dept) => (
            <button
              ...
              className="flex w-full items-center gap-2 px-3 py-2 text-sm text-bm-muted transition hover:bg-bm-surface/50 hover:text-bm-text first:rounded-t-lg last:rounded-b-lg"
            >
