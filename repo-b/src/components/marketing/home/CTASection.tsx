    ...
    <section className="flex flex-col gap-6 rounded-3xl border border-nv-text/16 bg-nv-surface/70 p-8 md:flex-row md:items-center md:justify-between">
      ...
      <div className="flex flex-wrap gap-3">
        <Link
          ...
          className="rounded-full border border-white/20 bg-white/[0.05] px-6 py-3 text-sm font-semibold text-white transition hover:border-white/35 hover:bg-white/[0.09]"
        >
          {primaryCta.label}
        </Link>
        <Link
