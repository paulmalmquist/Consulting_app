...
export function SystemConvergenceGraphic() {
  ...
  if (mounted && useFallback) {
    return (
      <div className="relative h-full min-h-[220px] w-full overflow-hidden rounded-3xl border border-nv-text/8 bg-nv-bg/40 p-4 sm:min-h-[250px] sm:p-6 md:min-h-[300px] md:p-8">
        <svg
          viewBox="0 0 600 400"
