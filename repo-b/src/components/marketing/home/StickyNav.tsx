      ...
      <div className="mx-auto flex w-full max-w-6xl items-center justify-center gap-6 px-4 py-4 md:px-6">
        ...
        <div className="flex items-center gap-3">
          <Link
            ...
            className="rounded-full border border-nv-text/12 px-4 py-2 text-xs font-semibold text-white transition hover:border-nv-text/20 hover:bg-white/5"
          >
            {secondaryCta.label}
          </Link>
          <Link
            href={primaryCta.href}
            className="rounded-full border border-white/20 bg-white/[0.05] px-4 py-2 text-xs font-semibold text-white transition hover:border-white/35 hover:bg-white/[0.09]"
          >
            {primaryCta.label}
          </Link>
        </div>
