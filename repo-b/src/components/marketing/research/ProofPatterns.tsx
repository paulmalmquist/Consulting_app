        ...
        {section.patterns.map((pattern) => (
          <details key={pattern.id} className="rounded-2xl border border-nv-text/10 bg-nv-bg/80 p-4">
            ...
            <div className="mt-3 space-y-3 text-sm text-nv-muted">
              ...
              <div>
                <p className="text-xs font-semibold uppercase tracking-[0.1em] text-nv-teal">What to show on a website</p>
              ...
              <div>
                <p className="text-xs font-semibold uppercase tracking-[0.1em] text-nv-teal">What evidence counts</p>
                <ul className="mt-1 space-y-1">
