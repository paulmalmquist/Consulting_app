  ...
  return (
    <section className="space-y-4">
      ...
      <div className="rounded-xl border border-bm-border/[0.08] bg-bm-surface/[0.85]">
        <div className="nv-eyebrow flex items-center justify-between border-b border-bm-border/[0.08] p-3 text-bm-muted2">
            ...
            {data.investment_contributions.map((c) => (
              ...
              >
                <td className="nv-table-cell px-3 py-2">
                  ...
                  {c.null_reason ? (
                    <span className="ml-2 rounded bg-rose-500/15 px-1.5 py-0.5 text-[10px] uppercase tracking-wide text-rose-200">
                ...
                <td className="nv-table-cell nv-metric px-3 py-2 text-right text-xs text-bm-muted2">
      ...
      <div className="rounded-xl border border-bm-border/[0.08] bg-bm-surface/[0.85]">
        <div className="flex flex-wrap items-center justify-between gap-2 border-b border-bm-border/[0.08] p-3">
          <div className="nv-eyebrow text-bm-muted2">
            Contribution to IRR
          </div>
          ...
          <tbody>
            {sortedContribs.map((c) => (
              ...
              >
                ...
                <td className="nv-table-cell nv-metric px-3 py-2 text-right text-bm-muted2">
