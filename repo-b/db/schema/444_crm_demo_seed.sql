...
DECLARE
  ...
  v_acct_branford   uuid := 'd0000001-0000-ca40-0001-000000000001';
  v_acct_redstone   uuid := 'd0000001-0000-ca40-0001-000000000002';
  v_acct_oakhill    uuid := 'd0000001-0000-ca40-0001-000000000003';
  v_acct_pinnacle   uuid := 'd0000001-0000-ca40-0001-000000000004';
  v_acct_greenfield uuid := 'd0000001-0000-ca40-0001-000000000005';

  -- Contact IDs
  v_ct_1 uuid := 'd0000001-0000-ca40-0002-000000000001';
  v_ct_2 uuid := 'd0000001-0000-ca40-0002-000000000002';
  v_ct_3 uuid := 'd0000001-0000-ca40-0002-000000000003';
  v_ct_4 uuid := 'd0000001-0000-ca40-0002-000000000004';
  v_ct_5 uuid := 'd0000001-0000-ca40-0002-000000000005';
  v_ct_6 uuid := 'd0000001-0000-ca40-0002-000000000006';
  v_ct_7 uuid := 'd0000001-0000-ca40-0002-000000000007';
  v_ct_8 uuid := 'd0000001-0000-ca40-0002-000000000008';

  -- Opportunity IDs
  v_opp_1 uuid := 'd0000001-0000-ca40-0003-000000000001';
  v_opp_2 uuid := 'd0000001-0000-ca40-0003-000000000002';
  v_opp_3 uuid := 'd0000001-0000-ca40-0003-000000000003';
  v_opp_4 uuid := 'd0000001-0000-ca40-0003-000000000004';
  v_opp_5 uuid := 'd0000001-0000-ca40-0003-000000000005';
  v_opp_6 uuid := 'd0000001-0000-ca40-0003-000000000006';
