...
_GET_CURSOR_TARGETS = [
    ...
    "app.services.outreach_personalizer.get_cursor",
    ...
    "app.services.bottom_up_fund_scope.get_cursor",
    "app.services.fund_expense_layer.get_cursor",
    "app.services.fund_waterfall_layer.get_cursor",
    "app.services.fund_decomposition.get_cursor",
