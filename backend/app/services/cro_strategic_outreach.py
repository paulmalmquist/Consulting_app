...
# Initial Novendor seeded lead dataset from April 9, 2026.
SEED_COMPANIES = [
    {
        "company_name": "Related Group",
        "industry": "real_estate",
        "employee_range": "200_1000",
        "stack": ["Procore", "Yardi", "Excel", "PM Reporting"],
        "multi_entity": True,
        "pe_backed": False,
        "ai_pressure": 4,
        "reporting": 5,
        "governance": 5,
        "fragmentation": 5,
        "wedge": "Portfolio-level intervention queue across condo and mixed-use developments",
        "capabilities": ["portfolio_variance_tracking", "executive_intervention_queue"],
        "hypothesis": "South Florida developer with 20-40 active projects annually. Complex condo and mixed-use pipeline likely depends on fragmented reporting across developments. High-fit wedge: replace fragmented reporting with centralized execution and real-time variance tracking.",
        "contacts": [{"name": "CFO (TBD)", "title": "Chief Financial Officer", "buyer_type": "CFO", "authority": "High"}],
    },
    {
        "company_name": "Greystar",
        "industry": "real_estate",
        "employee_range": "1000_plus",
        "stack": ["Yardi", "Excel", "Regional PM Systems", "BI Reporting"],
        "multi_entity": True,
        "pe_backed": False,
        "ai_pressure": 4,
        "reporting": 5,
        "governance": 5,
        "fragmentation": 4,
        "wedge": "Multi-region project rollup with automated variance detection",
        "capabilities": ["regional_rollup_reporting", "variance_detection"],
        "hypothesis": "National multifamily operator with 50+ active projects annually. Massive scale creates reporting lag and inconsistent project tracking. Strong value story: standardize workflows and automate executive reporting across regions.",
        "contacts": [{"name": "CFO (TBD)", "title": "Chief Financial Officer", "buyer_type": "CFO", "authority": "High"}],
    },
    {
        ...
        "industry": "healthcare",
        "employee_range": "1000_plus",
        "stack": ["Capital Planning", "Facilities Systems", "ERP", "Excel"],
        "multi_entity": True,
        "pe_backed": False,
        "ai_pressure": 4,
        "reporting": 5,
        "governance": 5,
        "fragmentation": 5,
        "wedge": "Budget vs actual and schedule delays across hospital expansions",
        "capabilities": ["capex_program_tracking", "capital_project_reporting"],
        "hypothesis": "South Florida health system with 15-30 capital projects annually. CapEx programs are likely tracked across multiple systems with limited real-time oversight. Strong executive narrative around centralized capital project tracking and automated reporting.",
        "contacts": [{"name": "CFO (TBD)", "title": "Chief Financial Officer", "buyer_type": "CFO", "authority": "High"}],
    },
    {
        "company_name": "HCA Healthcare (East Florida Division)",
        "industry": "healthcare",
        "employee_range": "1000_plus",
        "stack": ["Facilities Systems", "ERP", "Project Trackers", "Excel"],
        "multi_entity": True,
        "pe_backed": False,
        "ai_pressure": 4,
        "reporting": 5,
        "governance": 5,
        "fragmentation": 4,
        "wedge": "Intervention queue for multi-site healthcare projects",
        "capabilities": ["multi_site_execution_visibility", "project_intervention_queue"],
        "hypothesis": "Florida healthcare division with 20-50 projects annually. Distributed facilities likely create fragmented project oversight. The sharp value prop is a unified execution system replacing spreadsheet coordination across sites.",
        "contacts": [{"name": "CFO (TBD)", "title": "Chief Financial Officer", "buyer_type": "CFO", "authority": "High"}],
    },
    {
        "company_name": "Hall Boys Holdings",
        "industry": "professional_services",
        "employee_range": "50_200",
        "stack": ["ERP", "AP Automation", "Field Ops Tools", "Excel"],
        "multi_entity": True,
        "pe_backed": False,
        "ai_pressure": 5,
        "reporting": 4,
        "governance": 5,
        "fragmentation": 4,
        "wedge": "Cross-entity project and financial tracking across subsidiaries",
        "capabilities": ["shared_services_reporting", "cross_entity_operating_layer"],
        "hypothesis": "Multi-entity operating group with 10-25 projects annually. Multiple subsidiaries create coordination and reporting friction. High-confidence wedge: build a central operating layer across subsidiaries for project and financial tracking.",
        "contacts": [{"name": "CFO (TBD)", "title": "Chief Financial Officer", "buyer_type": "CFO", "authority": "High"}],
    },
    {
        ...
        "industry": "real_estate",
        "employee_range": "1000_plus",
        "stack": ["Property Systems", "Vendor Systems", "Excel", "Regional Reporting"],
        "multi_entity": True,
        "pe_backed": False,
        "ai_pressure": 3,
        "reporting": 4,
        "governance": 4,
        "fragmentation": 3,
        "wedge": "Vendor performance and cost tracking across building projects",
        "capabilities": ["vendor_workflow_standardization", "project_cost_monitoring"],
        "hypothesis": "US and Florida property manager with 25-50 projects annually. HOA and building-level projects are likely tracked inconsistently. Mid-market opportunity to standardize project and vendor workflows with clearer cost visibility.",
        "contacts": [{"name": "COO (TBD)", "title": "Chief Operating Officer", "buyer_type": "COO", "authority": "High"}],
    },
    {
        "company_name": "Brookfield Properties",
        "industry": "real_estate",
        "employee_range": "1000_plus",
        "stack": ["Portfolio Systems", "Asset Management Tools", "Excel", "BI"],
        "multi_entity": True,
        "pe_backed": False,
        "ai_pressure": 4,
        "reporting": 5,
        "governance": 5,
        "fragmentation": 4,
        "wedge": "Portfolio risk dashboard with intervention queue",
        "capabilities": ["portfolio_risk_monitoring", "intervention_workflows"],
        "hypothesis": "US real estate portfolio with 30+ projects annually. Complex portfolio likely suffers delayed reporting cycles. Strong executive story: real-time portfolio monitoring and intervention across assets.",
        "contacts": [{"name": "CFO (TBD)", "title": "Chief Financial Officer", "buyer_type": "CFO", "authority": "High"}],
    },
    {
        ...
        "industry": "real_estate",
        "employee_range": "1000_plus",
        "stack": ["ERP", "Community Ops Systems", "Excel", "Division Reporting"],
        "multi_entity": True,
        "pe_backed": False,
        "ai_pressure": 4,
        "reporting": 5,
        "governance": 4,
        "fragmentation": 4,
        "wedge": "Cost variance detection across active developments",
        "capabilities": ["cost_anomaly_detection", "development_rollup_reporting"],
        "hypothesis": "National homebuilder with 50+ active communities. High project volume makes centralized tracking difficult. Strong fit for automated reporting and anomaly detection across divisions.",
        "contacts": [{"name": "CFO (TBD)", "title": "Chief Financial Officer", "buyer_type": "CFO", "authority": "High"}],
    },
    {
        "company_name": "Trulieve",
        "industry": "retail",
        "employee_range": "1000_plus",
        "stack": ["Retail Rollout Tools", "Facilities Systems", "Excel", "PM Trackers"],
        "multi_entity": True,
        "pe_backed": False,
        "ai_pressure": 4,
        "reporting": 4,
        "governance": 4,
        "fragmentation": 3,
        "wedge": "Multi-location build tracking with schedule delay visibility",
        "capabilities": ["store_rollout_tracking", "delay_detection"],
        "hypothesis": "Multi-state cannabis retailer with 10-30 store builds annually. Rapid expansion likely creates execution inconsistencies. Good mid-sized wedge around standardized rollout workflows and delay visibility.",
        "contacts": [{"name": "COO (TBD)", "title": "Chief Operating Officer", "buyer_type": "COO", "authority": "High"}],
    },
    {
        ...
        "industry": "retail",
        "employee_range": "1000_plus",
        "stack": ["Facilities Systems", "Excel", "CapEx Trackers", "ERP"],
        "multi_entity": True,
        "pe_backed": False,
        "ai_pressure": 3,
        "reporting": 3,
        "governance": 4,
        "fragmentation": 3,
        "wedge": "Budget vs actual tracking across dealership upgrades",
        "capabilities": ["facility_upgrade_tracking", "budget_variance_reporting"],
        "hypothesis": "Automotive retail operator with 10-20 facility upgrades annually. Facility projects are likely still tracked manually across locations. Mid-sized opportunity for centralized execution tracking.",
        "contacts": [{"name": "CFO (TBD)", "title": "Chief Financial Officer", "buyer_type": "CFO", "authority": "High"}],
    },
    {
        ...
        "employee_range": "1000_plus",
        "stack": ["Infrastructure PM", "ERP", "Port Operations Systems", "Excel"],
        "multi_entity": True,
        "pe_backed": False,
        "ai_pressure": 3,
        "reporting": 4,
        "governance": 5,
        "fragmentation": 4,
        "wedge": "Large project monitoring and executive reporting for infrastructure programs",
        "capabilities": ["infrastructure_program_monitoring", "executive_packet_reporting"],
        "hypothesis": "Miami-based hospitality operator with 10-25 infrastructure projects annually. Infrastructure and port projects likely lack unified tracking. Strong enterprise wedge around centralized execution reporting.",
        "contacts": [{"name": "CFO (TBD)", "title": "Chief Financial Officer", "buyer_type": "CFO", "authority": "High"}],
    },
    {
        ...
        "industry": "logistics",
        "employee_range": "1000_plus",
        "stack": ["Facilities Systems", "ERP", "Rollout Trackers", "Excel"],
        "multi_entity": True,
        "pe_backed": False,
        "ai_pressure": 3,
        "reporting": 3,
        "governance": 4,
        "fragmentation": 3,
        "wedge": "Facility rollout monitoring across distributed sites",
        "capabilities": ["distributed_facility_tracking", "capex_visibility"],
        "hypothesis": "Miami logistics operator with 10-20 facility projects annually. Distributed facilities likely create tracking inefficiencies. Mid-market wedge around centralized CapEx tracking and rollout monitoring.",
        "contacts": [{"name": "COO (TBD)", "title": "Chief Operating Officer", "buyer_type": "COO", "authority": "High"}],
    },
    {
        "company_name": "ADT",
        "industry": "professional_services",
        "employee_range": "1000_plus",
        "stack": ["Ops Systems", "Infrastructure Trackers", "ERP", "Excel"],
        "multi_entity": True,
        "pe_backed": False,
        "ai_pressure": 3,
        "reporting": 3,
        "governance": 4,
        "fragmentation": 3,
        "wedge": "Project workflow standardization for operational infrastructure work",
        "capabilities": ["workflow_standardization", "ops_project_reporting"],
        "hypothesis": "Florida-based security and operations company with 10-25 infrastructure projects. Operational projects likely lack standardized tracking today. Clear value around replacing manual coordination.",
        "contacts": [{"name": "COO (TBD)", "title": "Chief Operating Officer", "buyer_type": "COO", "authority": "High"}],
    },
    {
        ...
        "employee_range": "200_1000",
        "stack": ["Infrastructure PM", "Capital Planning", "Excel", "Milestone Reporting"],
        "multi_entity": True,
        "pe_backed": False,
        "ai_pressure": 4,
        "reporting": 5,
        "governance": 5,
        "fragmentation": 4,
        "wedge": "Milestone tracking and delay visibility for transportation programs",
        "capabilities": ["milestone_tracking", "schedule_delay_detection"],
        "hypothesis": "Florida transportation infrastructure operator with 10-20 major projects. Large capital projects require high coordination and executive visibility. Strong high-value wedge around real-time execution monitoring.",
        "contacts": [{"name": "CFO (TBD)", "title": "Chief Financial Officer", "buyer_type": "CFO", "authority": "High"}],
    },
    {
        ...
        "industry": "real_estate",
        "employee_range": "1000_plus",
        "stack": ["Asset Management Systems", "Development Systems", "Excel", "Portfolio Reporting"],
        "multi_entity": True,
        "pe_backed": False,
        "ai_pressure": 4,
        "reporting": 5,
        "governance": 5,
        "fragmentation": 4,
        "wedge": "Portfolio-level insights across complex multi-asset developments",
        "capabilities": ["portfolio_insights", "reporting_stack_consolidation"],
        "hypothesis": "National real estate platform with 20-40 projects. Complex multi-asset reporting likely depends on a fragmented stack. Strong enterprise wedge around portfolio-level insights and reporting consolidation.",
        "contacts": [{"name": "CFO (TBD)", "title": "Chief Financial Officer", "buyer_type": "CFO", "authority": "High"}],
    },
    {
        "company_name": "JLL",
        "industry": "professional_services",
        "employee_range": "1000_plus",
        "stack": ["PDS Tooling", "Client Reporting", "Excel", "Services Workflows"],
        "multi_entity": True,
        "pe_backed": False,
        "ai_pressure": 4,
        "reporting": 5,
        "governance": 5,
        "fragmentation": 5,
        "wedge": "Side-by-side comparison of labor-heavy PDS services versus productized system",
        "capabilities": ["pds_workflow_standardization", "executive_reporting_automation"],
        "hypothesis": "Real estate services platform with 50+ projects. Traditional PDS delivery is labor-heavy and reporting-intensive. Strong strategic wedge: replace manual services effort with a systemized operating layer.",
        "contacts": [{"name": "Operations Leadership (TBD)", "title": "Operations Leadership", "buyer_type": "Other", "authority": "High"}],
    },
    {
        "company_name": "Publix Super Markets",
        "industry": "retail",
        "employee_range": "1000_plus",
        "stack": ["Store Development", "Facilities Systems", "Excel", "Rollout Reporting"],
        "multi_entity": True,
        "pe_backed": False,
        "ai_pressure": 3,
        "reporting": 4,
        "governance": 4,
        "fragmentation": 3,
        "wedge": "Store build tracking for expansion and renovation programs",
        "capabilities": ["store_project_tracking", "rollout_reporting"],
        "hypothesis": "Southeast retailer with 10-25 store projects annually. Expansion work is likely tracked across multiple teams and tools. Mid-sized wedge around a central rollout system with better execution visibility.",
        "contacts": [{"name": "COO (TBD)", "title": "Chief Operating Officer", "buyer_type": "COO", "authority": "High"}],
    },
    {
        "company_name": "Chewy",
        "industry": "logistics",
        "employee_range": "1000_plus",
        "stack": ["Facility Expansion", "Ops Systems", "Excel", "Project Tracking"],
        "multi_entity": True,
        "pe_backed": False,
        "ai_pressure": 3,
        "reporting": 3,
        "governance": 4,
        "fragmentation": 3,
        "wedge": "Facility rollout tracking across fulfillment expansion projects",
        "capabilities": ["facility_expansion_tracking", "execution_reporting"],
        "hypothesis": "Florida-based e-commerce logistics operator with 10-20 facility projects. Fulfillment expansion likely lacks centralized tracking. Good mid-sized wedge around execution and reporting for distributed builds.",
        "contacts": [{"name": "COO (TBD)", "title": "Chief Operating Officer", "buyer_type": "COO", "authority": "High"}],
    },
]
