...
def advance_opportunity_stage(
    *,
    ...
    with get_cursor() as cur:
        ...
        # Stage moves are unrestricted. Drag-drop should never be blocked
        # by missing contacts, outreach, or next-action records — those
        # are surfaced as health signals on the card, not gates on the move.
