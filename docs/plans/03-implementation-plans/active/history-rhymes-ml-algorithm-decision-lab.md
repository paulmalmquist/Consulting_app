...
`10024_history_rhymes_observation_embeddings.sql` creates
...
`10025_history_rhymes_episode_promotion_candidates.sql` (`hr_episode_promotion_candidates`
...
`10026_history_rhymes_promotion_audit_type.sql` controlled-widens the inline
...
C11 adds additive migration `10027_history_rhymes_episode_origin.sql`: nullable
