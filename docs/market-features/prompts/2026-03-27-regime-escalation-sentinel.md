...
> **Refreshed:** 2026-03-27 by fin-feature-builder | Spec stable — no changes from 2026-03-26. Build-ready.
...
**Build Order:** 2 of 3 (depends on Regime Classifier for `market_regime_snapshot` table)
