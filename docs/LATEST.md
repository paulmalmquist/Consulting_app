...
| File | Date | Top pick |
|---|---|---|
| `docs/feature-radar/2026-03-22.md` | 2026-03-22 | Predictive Investor Communication Parsing (ENHANCEMENT — close Juniper Square AI CRM gap using existing extraction engine + CRM) |
...
- **Winston eval novendor (smoke)** - pass: 3 pass / 0 fail · [2026-06-16_0650](./docs/ai-testing/reports/2026-06-16_0650_novendor.md)  _updated 2026-06-16_0650 UTC_
