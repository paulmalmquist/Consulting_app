...
| Observation embeddings | `hr_feature_store_observation_embeddings` (C2-B, 10020) | `(observation_id, model_obs_version, embedding_model_version)` | append-only current-state embeddings; comparison surface |
