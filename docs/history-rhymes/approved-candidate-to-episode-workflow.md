...
| Observation embeddings | `hr_feature_store_observation_embeddings` (10020) | current-state embeddings; comparison surface |
| Promotion airlock | `hr_episode_promotion_candidates` (10021) | reviewed, evidence-gated candidates |
