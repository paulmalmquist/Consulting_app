...
import these constants. PR 4's Flink statement (infra/confluent/flink/
02_anomaly_route.sql) encodes the same predicate; test_stargate_codec parses the
SQL and asserts the constants match, so the two definitions cannot drift.
