...
# MAGIC %md
# MAGIC # 01 Ingest Public Sources (thin adapter)
# MAGIC Registers public NOAA/FEMA sources. Logic lives in `weather_risk.stages.ingest`.
...
from weather_risk.stages import ingest

source_rows = ingest.run_spark(spark, dbutils)
display(source_rows)
