...
Rules:
- Read the repo and user request, then decide whether the task belongs with architect, builder, QA, data, Claude, or Codex.
...
4. Use `builder-winston`, `claude-winston`, or `codex-winston` for implementation.
5. Use `qa-winston` for validation.
6. Summarize status and next steps for the user.
